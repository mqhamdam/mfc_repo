...
// Assignment1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAssignment1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAssignment1App::OnAppAbout)
...
// Создание CAssignment1App

CAssignment1App::CAssignment1App() noexcept
{
	...
	SetAppID(_T("Assignment1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CAssignment1App

CAssignment1App theApp;


// Инициализация CAssignment1App
...
BOOL CAssignment1App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CAssignment1Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CAssignment1View));
	if (!pDocTemplate)
		return FALSE;
...
int CAssignment1App::ExitInstance()
{
...
// Обработчики сообщений CAssignment1App
...
void CAssignment1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
